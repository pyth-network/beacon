module github.com/pyth-network/beacon

go 1.19

require (
	github.com/alecthomas/kong v0.8.0
	github.com/certusone/wormhole/node v0.0.0-20230918141706-a3df706b8a4c
...
// Copied from https://github.com/wormhole-foundation/wormhole/blob/v2.23.10/node/go.mod#L360
